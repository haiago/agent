...
description: Quy trình Sentinel Refinery-v6.7 - Ép Agent trích xuất tinh hoa nguyên tử và bảo trì mạng lưới Zettelkasten thực chiến.
---
...
Mọi tri thức thu hoạch từ dự án thực tế PHẢI tuân thủ:
1. **Project MOC**: PHẢI tạo một file `[Project Name] MOC.md` trong `/MOCs`.
2. **Mandatory Tag**: Phải có tag `#projects` trong Project MOC.
3. **Internal Linking**: Project MOC phải liên kết tới note bối cảnh tại `/Projects/[Project Name].md`.
4. **Cross-Linking**: Phải liên kết Project MOC tới các Concepts/Tools dùng chung đã có.
...
- **Lò luyện Refinery-v6.7 (Automator)**: `.agent/skills/master-brain-management/scripts/ingest-memory.sh`
...
## 🔄 Quy trình Ingest Refinery-v6.7 (The Automator Loop)
