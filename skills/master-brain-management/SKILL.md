...
5. **Footer Required**: Mọi note PHẢI kết thúc bằng DUY NHẤT một đường kẻ `---` và DUY NHẤT một dòng link `[[index]] | [[Tên MOC]]`. CẤM chèn thêm các layer kẻ ngang hoặc nhiều dòng link chồng chéo (**Rule 1 dòng**). Thiếu hoặc sai định dạng = vi phạm, flag vào Wiki Health MOC.
